...
const ExerciseCard = ({ exercise, classnameo }) => {
    return (
        <Link className={classnameo} to={`/exercise/${exercise.id}`}
            ...
            <Stack direction="row">
                <Button sx={{
                    ml: '21px', color: '#fff', background: '#ffa9a9', fontSize: '14px', borderRadius: "15px", p: '7px 2px',
                ...
                <Button sx={{
                    ml: '21px', color: '#fff', background: '#ffcc77', fontSize: '14px', borderRadius: "15px", padding: '7px 3px',
                    textTransform: 'capitalize'
                }}>
                    {exercise.target}
                </Button>
